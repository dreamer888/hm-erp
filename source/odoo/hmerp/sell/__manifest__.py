...
#    Copyright (C) 2014 唤梦科技 (http://www.dreammm.net).
#    All Rights Reserved
#
...
##############################################################################
{
    ...
    '''
                            ...
                            通过创建销售订单，审核后将销售订单行中的商品销售给客户，来完成销售功能。
                            通过创建销售退货订单，审核后将退货订单行中的商品退回，来完成销售退货功能。
                            通过创建销售变更单，选择原始销售订单，审核后将销售变更单行中的商品调整到原始销售订单行，来完成销售调整功能。
