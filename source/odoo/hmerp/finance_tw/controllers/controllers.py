...
if hasattr(sys, 'frozen'):
    ...
    loader = jinja2.PackageLoader('odoo.addons.finance_tw', "views")
...
class Menus(http.Controller):
    @http.route('/menus', type='http', auth="user")
    def render_menus_page(self):
        menus = http.request.env['ir.ui.menu'].search([('parent_id','=',False)])
        return http.request.render('core.menus_template',{'menus':menus})
